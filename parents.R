...
table(Book1$`Kindly indicate your category appropriately`)

#Split parents
parents <- filter(Book1,`Kindly indicate your category appropriately`%in% "Parent/ Guardian")

refactor <- 580/15
#KUCCPS Mandate-----
Mandate <- parents[c(12:17)]
length(Mandate)
nrow(Mandate)
...
round(table(age[,1])*(refactor))



#Interaction-----
interact <- parents[c(5)]
length(interact)
nrow(interact)
