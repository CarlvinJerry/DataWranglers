...
comparison <- df %>% transmute("comparison with other related service institutions in the education sector" =  gsub("\\[|\\]", "",stringr::str_extract(df$variable,"\\[.*?\\]")))
...
write.csv(final," csiflagships.csv")
